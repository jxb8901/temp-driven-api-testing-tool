...
public final class Version {
    ...
    public static final String TEMPLATE_SCHEMA = "att-template/v2.6";
    public static final String LEGACY_TEMPLATE_SCHEMA = "att-template/v2.5";
    public static final String OLDER_TEMPLATE_SCHEMA = "att-template/v2.3";
